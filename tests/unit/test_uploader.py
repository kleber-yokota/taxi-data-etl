...
class TestUploadFile:
    def test_success(self, temp_file, s3_client_mock):
    ...
    def test_skipped_when_hash_matches(self, temp_file, s3_client_mock):
    ...
    def test_upload_when_hash_differs(self, temp_file, s3_client_mock):
        s3_client_mock.head_object.return_value = {
    ...
    def test_upload_when_no_metadata(self, temp_file, s3_client_mock):
        s3_client_mock.head_object.return_value = {}
    ...
    def test_source_not_found(self, s3_client_mock):
        result = upload_file(
    ...
    def test_network_error_on_head(self, temp_file, s3_client_mock):
    ...
    def test_network_error_on_upload(self, temp_file, s3_client_mock):
        s3_client_mock.head_object.side_effect = make_client_error("404")
    ...
    def test_head_object_403_raises(self, temp_file, s3_client_mock):
    ...
    def test_bucket_path_with_filename(self, temp_file, s3_client_mock):
        s3_client_mock.head_object.side_effect = make_client_error("404")
    ...
    def test_upload_includes_metadata(self, temp_file, s3_client_mock):
        s3_client_mock.head_object.side_effect = make_client_error("404")
        ...
        s3_client_mock.upload_file.assert_called_once_with(
            ...
            ExtraArgs={
                "Metadata": {"hash": "mysha256hash", "hash_type": "sha256"}
            },
        )

    def test_upload_custom_hash_type(self, temp_file, s3_client_mock):
        s3_client_mock.head_object.side_effect = make_client_error("404")
        ...
        s3_client_mock.upload_file.assert_called_once_with(
            ...
            "raw/2024/test.parquet",
            ExtraArgs={
                "Metadata": {"hash": "md5hash123", "hash_type": "md5"}
            },
        )

    def test_skipped_custom_hash_type(self, temp_file, s3_client_mock):
        s3_client_mock.head_object.return_value = {
    ...
    def test_not_skipped_when_hash_type_differs(self, temp_file, s3_client_mock):
        s3_client_mock.head_object.return_value = {
